  ...
  head: () => ({
    meta: [
      ...
      { title: "Marketplace Systems Architect & Full-Stack Engineer" },
      {
        name: "description",
        content:
          "Portfolio of a Full-Stack Marketplace Specialist — building multi-vendor platforms, real-time bidding engines, and high-scale commerce systems.",
      },
      { name: "author", content: "Marketplace Systems Architect" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Tajawal:wght@400;500;700;800&display=swap",
      },
    ],
  }),
